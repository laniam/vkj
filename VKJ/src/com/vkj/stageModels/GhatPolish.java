 ...
 * 
 */
public class GhatPolish extends Stage {
	...
	public class OrderPlaced {
		...
		public String mouldFromMagnetPolish = "";
		...
		/**
		 * @param mouldAvailable
		 *            the mouldAvailable to set
		 */
		...
		/**
		 * @return the mouldFromMagnetPolish
		 */
		public String getMouldFromMagnetPolish() {
			return mouldFromMagnetPolish;
		}

		/**
		 * @param mouldFromMagnetPolish
		 *            the mouldFromMagnetPolish to set
		 */
		public void setMouldFromMagnetPolish(String mouldFromMagnetPolish) {
			this.mouldFromMagnetPolish = mouldFromMagnetPolish;
		}
